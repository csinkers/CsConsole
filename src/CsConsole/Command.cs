...
{
    public Task InvokeAsync(ArgumentSource args, IConsoleOutput o, CancellationToken ct) => func(args, o, ct);
...
public class AsyncCommand<T>(string name, AsyncCommandMethod<T> func)
    : IAsyncCommand<T>
